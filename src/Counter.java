...
public class Counter {
    ...
    private void fanon(int start, int end) {
        ...
        applySubcode('1', start, cut);
        applySubcode('0', cut+1, end);
    ...
    public String toString() {
        ...
        sb.append("Durchschnittliche Codewortlänge = "+df.format(avg_l)+" Bits/Symbol \n");
    ...
    private void outputConsole(StringBuilder sb, DecimalFormat df) {
        ...
        Formatter f = new Formatter(sb, Locale.GERMANY);
